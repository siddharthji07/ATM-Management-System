...
public class Deposit extends JFrame implements ActionListener {
    ...
    JLabel text = new JLabel("Enter the Amount you want to Deposit");  // writing text over our page
    ...
    public void actionPerformed(ActionEvent ae){
      if(ae.getSource()== deposit){
        ...
        if (number.equals("")) { 
                JOptionPane.showMessageDialog(null, " Please Enter the Amount you want tpo Deposit");
            } 
        else {
              try{
                Conn c = new Conn();  // to establish the connection with the database to call the conn class
               // String query = " insert into signup values('" + pinnumber + "', '" + date + "', 'Deposit', '" + number+"')";
